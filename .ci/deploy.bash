...
ssh azureuser@20.81.125.206 "docker stop brawler || docker load -i brawler-server.tar.gz && docker run --name brawler --rm -d -it -p 4433:4433/tcp -p 4433:4433/udp brawler-server"
